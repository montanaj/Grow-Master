...
@interface  InitailPlayThroughScnen1()
...
@implementation InitailPlayThroughScnen1
...
- (void)createSceneContents
{
    ...
    SKSpriteNode *backgroundSprite = [SKSpriteNode spriteNodeWithImageNamed:@"intro1All.png"];
    backgroundSprite.zPosition = 18;
    backgroundSprite.position = CGPointMake(self.size.width/2, self.size.height/2);
    [self addChild:backgroundSprite];

    self.introTextArray = @[@"There's a lot of things you've heard about the future, a lot of things you've heard about the past...",
                            @"Of course, that was long ago...",
                            @"Now its just you, here"];
...
//    SKSpriteNode *touchedNode = (id)[self nodeAtPoint:pointTappedInSKView];
    ...
    else if (self.indexOfIntroText > self.introTextArray.count - 1)
    {
        ...
        InitailPlayThroughScene2 *scene2 = [[InitailPlayThroughScene2 alloc] initWithSize:CGSizeMake(640, 1136)];
